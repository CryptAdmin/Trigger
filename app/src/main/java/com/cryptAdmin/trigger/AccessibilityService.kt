package com.cryptAdmin.trigger
...
import com.cryptAdmin.trigger.admin.DeviceAdminManager
...
class AccessibilityService : AccessibilityService() {
    ...
    private class LockReceiver(
        private val service: WeakReference<com.cryptAdmin.trigger.AccessibilityService>,
    ) : BroadcastReceiver() {
